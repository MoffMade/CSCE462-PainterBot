...
public:
	...
	vector<vector<double> > inverseSolver(double end_x, double end_y, double phi); //Takes X and Y coord of requested end effector position and upadtes the DH parameters
};
